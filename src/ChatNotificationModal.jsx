...
const ChatNotificationModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-gradient-to-br from-purple-900 to-pink-900 rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl border border-white/20"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-pink-400 transition-colors"
                />
              </div>
