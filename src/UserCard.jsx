function UserCard({ user }) {
  return (
    <div className="bg-white rounded-2xl shadow-lg p-4 flex flex-col items-center max-w-sm sm:max-w-md md:max-w-lg mx-auto transition-all duration-300 border border-gray-100">
